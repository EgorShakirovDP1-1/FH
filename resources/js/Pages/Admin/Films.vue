            ...
            <div class="row">
                ...
                <div class="overflow-auto col-md-9 mt-3">
                    <div class="d-flex justify-content-between" aria-label="films list header">
                        <h3>Films list</h3>
                        <Link :href="route('films.create')" class="btn btn-warning text-primary pb-2 rounded"
                    ...
                    <table class="table" aria-label="films list table">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(film, index) in films.data" :key="film.id">
                                ...
                                <td aria-label="film genre type">{{ film.main_hero }}</td>
                                <td aria-label="film genre type">{{ film.genre }}</td>
