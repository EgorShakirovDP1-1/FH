            ...
            <div class="col-12 col-sm-8 col-md-6">
                <form enctype="multipart/form-data" @submit.prevent="handleSubmit">
                    ...
                    <div class="form-group mt-3" aria-labelledby="genreTypeLabel">
                        <label for="main_hero" class="text-dark" id="genreTypeLabel">Genrework</label><br>
                        <input v-model="form.main_hero" type="text" name="main_hero" id="main_hero"
                            class="form-control border-primary" placeholder="Enter genre type">
                        <div v-if="errors.main_hero" class="d-block mt-2" role="alert">
                            <span class="fs-5 text-danger">
                                {{ errors.main_hero }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3" aria-labelledby="genreTypeLabel">
                        <label for="genre" class="text-dark" id="genreTypeLabel">Genre Type</label><br>
                    ...
                    <div class="form-group mt-3" aria-labelledby="volumeLabel">
                        <label for="volume" class="text-dark" id="volumeLabel">CO2 Volume</label><br>
                        <input v-model="form.volume" type="number" name="volume" id="volume"
                            class="form-control border-primary" placeholder="Enter CO2 volume">
                    ...
                    <div class="form-group mt-3" aria-labelledby="pricePerDayLabel">
                        <label for="ndc" class="text-dark" id="pricePerDayLabel">Price per day</label><br>
                        <input v-model="form.ndc" type="number" name="ndc" id="ndc"
                            class="form-control border-primary" placeholder="Enter price per day">
                        <div v-if="errors.ndc" class="d-block mt-2" role="alert">
                            <span class="fs-5 text-danger">
                                {{ errors.ndc }}
                            </span>
                        </div>
